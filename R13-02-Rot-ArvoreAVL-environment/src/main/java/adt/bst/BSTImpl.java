...
public class BSTImpl<T extends Comparable<T>> implements BST<T> {
	...
	protected static final int ZERO_DEGREE = 0;
	protected static final int ONE_DEGREE = 1;
	protected static final int TWO_DEGREE = 2;
	...
	protected int getDegreeNode(BSTNode<T> node) {
